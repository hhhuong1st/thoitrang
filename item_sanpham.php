...
<div class='product-item' style="background: white; padding: 15px; text-align: center; width: calc(25% - 20px); box-sizing: border-box; box-shadow: 0 4px 8px rgba(0,0,0,0.05); border-radius: 8px;">
    ...
    <a href="giohang.php?them_id=<?php echo $row['ma_sp']; ?>&kieu=mua" class="btn-mua">
       Mua ngay
    </a>
    
    <a href="giohang.php?them_id=<?php echo $row['ma_sp']; ?>&kieu=them" class="btn-them" onclick="alert('Đã thêm sản phẩm vào giỏ hàng thành công!')">
       Thêm vào giỏ hàng
    </a>
</div>